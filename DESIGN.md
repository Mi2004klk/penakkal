...
| heading-md | 30px | 1.38 | -0.21px | `--text-heading-md` |
...
| Name | Value | Token |
|------|-------|-------|
| 8 | 8px | (Use hardcoded 8px or utility equivalent) |
| 16 | 16px | `--element-gap` |
...
- **List view:** 4:3 (`aspect-[4/3]`)
- **Magazine view:** 4:5 on mobile (`aspect-[4/5]`), 4:3 on desktop (`aspect-[4/3]`)
- **Hero cover:** 21:9 on desktop (`md:aspect-[21/9]`)

*(Note: These are explicitly intentional per-view and bypass tokens to maintain specific editorial framing. Add `--aspect-*` tokens to `globals.css` only if these exact ratios are reused in generic components elsewhere.)*
...
:root {
  ...
  --leading-heading-md: 1.38;
  --tracking-heading-md: -0.21px;
  --text-display: 96px;
...
Penakkal mandates a minimum WCAG AA contrast ratio of 4.5:1 for normal body text, and 3:1 for large text across both Light and Dark themes. We strictly enforce this via a CI script (`npm run test:contrast`).

### Token Pass Matrix

| Theme | Background | Foreground | Ratio | Minimum Required | Status |
| --- | --- | --- | --- | --- | --- |
| Light | `pure-white-card` (#ffffff) | `heading` (#000000) | 21.00:1 | 4.5:1 | ✅ PASS |
| Light | `pure-white-card` (#ffffff) | `body-text` (#44403b) | 10.28:1 | 4.5:1 | ✅ PASS |
| Light | `pure-white-card` (#ffffff) | `muted-text` (#4d4843) | 9.04:1 | 4.5:1 | ✅ PASS |
| Light | `pure-white-card` (#ffffff) | `text-link` (#008236) | 4.95:1 | 4.5:1 | ✅ PASS |
| Light | `cream-paper` (#fcf7ed) | `heading` (#000000) | 19.67:1 | 4.5:1 | ✅ PASS |
| Light | `cream-paper` (#fcf7ed) | `body-text` (#44403b) | 9.63:1 | 4.5:1 | ✅ PASS |
| Light | `cream-paper` (#fcf7ed) | `muted-text` (#4d4843) | 8.46:1 | 4.5:1 | ✅ PASS |
| Light | `cream-paper` (#fcf7ed) | `text-link` (#008236) | 4.63:1 | 4.5:1 | ✅ PASS |
| Light | `forest-stage` (#0d542b) | `pure-white` (#ffffff) | 9.05:1 | 4.5:1 | ✅ PASS |
| Light | `forest-stage` (#0d542b) | `lime-sprout` (#b9ff78) | 7.60:1 | 4.5:1 | ✅ PASS |
| Dark | `pure-white-card` (#212121) | `heading` (#f3f4f6) | 14.63:1 | 4.5:1 | ✅ PASS |
| Dark | `pure-white-card` (#212121) | `body-text` (#d1d5db) | 10.93:1 | 4.5:1 | ✅ PASS |
| Dark | `pure-white-card` (#212121) | `muted-text` (#9ca3af) | 6.34:1 | 4.5:1 | ✅ PASS |
| Dark | `pure-white-card` (#212121) | `text-link` (#b9ff78) | 13.52:1 | 4.5:1 | ✅ PASS |
| Dark | `cream-paper` (#171717) | `heading` (#f3f4f6) | 16.29:1 | 4.5:1 | ✅ PASS |
| Dark | `cream-paper` (#171717) | `body-text` (#d1d5db) | 12.17:1 | 4.5:1 | ✅ PASS |
| Dark | `cream-paper` (#171717) | `muted-text` (#9ca3af) | 7.06:1 | 4.5:1 | ✅ PASS |
| Dark | `cream-paper` (#171717) | `text-link` (#b9ff78) | 15.06:1 | 4.5:1 | ✅ PASS |
| Dark | `forest-stage` (#0d542b) | `pure-white` (#ffffff) | 9.05:1 | 4.5:1 | ✅ PASS |
| Dark | `forest-stage` (#0d542b) | `lime-sprout` (#b9ff78) | 7.60:1 | 4.5:1 | ✅ PASS |

## Interaction Spec

### Motion Vocabulary
Penakkal utilizes a heavily constrained motion vocabulary to prevent UI fatigue.
- **Micro-interactions (Hover/Focus)**: Use immediate CSS transitions (`--transition-fast` 150ms). Elements should shift border color or text color, avoiding scale manipulation unless absolutely necessary.
- **Entrance Choreography**: Modals, Drawers, and Empty States use `animate-fade-in-up` (0.8s ease-out, 8px vertical shift) to gently lift into view without snapping.
- **Framer Motion Springs**: Used exclusively for complex layout transitions (like Toast/Snackbar entry or Filter Panel expanding) where rigid CSS curves feel too mechanical.

### Print Rules & Visibility
- **Print Mode**: The `print` media query actively targets and strips out headers, footers, navigation, and any element with `data-print-hide` or `.no-print`. Body prose expands to 100% width, and images apply `page-break-inside: avoid`.
- **Content Visibility**: `.prose-article` enforces `content-visibility: auto` paired with `contain-intrinsic-size: 0 1000px` to drastically improve scrolling performance and render times on extremely long articles.

### Reduced Motion Parity
All animations strictly respect `@media (prefers-reduced-motion: reduce)`. If the OS sets reduced motion, all CSS animations snap to `0.01ms`, rendering instantly. Javascript-driven animations (Framer Motion) must respect this toggle natively.
