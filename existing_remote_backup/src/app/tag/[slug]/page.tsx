...
export default async function TagPage({
  ...
  const jsonLd = {
    ...
    "itemListElement": [{
      ...
      "position": 2,
      "name": decodedSlug,
      "item": `https://penakkal.com/tag/${slug}`
    }]
  };
    ...
    <div className="min-h-screen flex flex-col pt-16 bg-[color:var(--color-surface-page)]">
      ...
      <section className="relative py-16 md:py-24 bg-[color:var(--color-surface-card)] overflow-hidden border-b border-[color:var(--color-border-default)]">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <span className="section-eyebrow text-[color:var(--color-muted-text)] mb-4 inline-block">குறிச்சொல்</span>
          <h1 className="editorial-headline mb-6 inline-block w-full wavy-underline">#{decodedSlug}</h1>
